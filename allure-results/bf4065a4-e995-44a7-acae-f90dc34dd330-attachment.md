...
- Name: API\07-api-testing.spec.ts >> Combinar API + UI >> usar un nombre real obtenido por API para completar el checkout de SauceDemo
- Location: tests\API\07-api-testing.spec.ts:95:7
